...
class DataValidation:
    def __init__(self,data_ingestion_artifact:DataIngestionArtifact,data_validation_config:DataValidationConfig):
        try:
            ...
            logging.error(f"Error in Data Validation __init__ : {str(e)}")
            raise NetworkSecurityException(f"Error in Data Validation __init__ : {str(e)}")
    ...
    def validate_number_of_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            logging.info(f"Required Number of columns in schema file : {number_of_columns}")
    ...
    def validate_number_of_numerical_columns(self,dataframe:pd.DataFrame)->bool:
        try:
            ...
            logging.info(f"Required Number of numerical columns in schema file : {number_of_numerical_columns}")
            logging.info(f"Dataframe has numerical columns : {dataframe.select_dtypes(include=['float64','int64']).columns}")
            if len(dataframe.select_dtypes(include=['float64','int64']).columns)==number_of_numerical_columns:
                return True
            else:
                return False
        except Exception as e:
    ...
    def initiate_data_validation(self)->DataValidationArtifact:
        try:
            ...
            logging.info(f"Data read from train and test file done")
