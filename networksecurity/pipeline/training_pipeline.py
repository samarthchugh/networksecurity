...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            data_ingestion: DataIngestion = DataIngestion(config=self.data_ingestion_config)
    ...
    def start_data_validation(self,data_ingestion_artifact: DataIngestionArtifact):
        try:
            ...
            data_validation: DataValidation = DataValidation(data_ingestion_artifact=data_ingestion_artifact,data_validation_config=data_validation_config)
    ...
    def start_data_transformation(self,data_validation_artifact: DataValidationArtifact):
        try:
            data_transformation_config: DataTransformationConfig = DataTransformationConfig(training_pipeline_config=self.training_pipeline_config)
            data_transformation: DataTransformation = DataTransformation(data_validation_artifact=data_validation_artifact,data_transformation_config=data_transformation_config)
    ...
    def start_model_trainer(self,data_transformation_artifact:DataTransformationArtifact):
        try:
            model_trainer_config: ModelTrainerConfig = ModelTrainerConfig(training_pipeline_config=self.training_pipeline_config)
            model_trainer: ModelTrainer = ModelTrainer(model_trainer_config=model_trainer_config,data_transformation_artifact=data_transformation_artifact)
